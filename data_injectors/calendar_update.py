...
# print(get_first_day_of_the_quarter(datetime.now()),get_last_day_of_the_quarter(datetime.now()))
# %%
df
# %%
...
conn
# %%
df.to_sql('test_calendar', conn, if_exists = 'append', index = False)#, schema = str(schema))
# %%
