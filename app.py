...
fig.update_layout(yaxis={'categoryorder':'max ascending'},title_text="PTS per game for top "+str(top_n_players)+" players at "+ pos +"'s" +\
...
def update_figure(stat,y,pos,top_n_players,season_type):
	...
	fig.update_layout(yaxis={'categoryorder':'max ascending'},
					  title_text= stat+ " per game for top "+str(top_n_players)+ pos +"'s"+\
